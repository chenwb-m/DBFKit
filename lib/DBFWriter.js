...
(function() {
  var Buffer, DBFWriter, FIELDSIZE, Iconv, fs, lFill, path, rFill, util;
  ...
  DBFWriter = (function() {
    ...
    */
    ...
    function DBFWriter(header, doc, dirName, fileName, options) {
      this.doc = doc;
    ...
    DBFWriter.prototype.write = function() {
      var wsBuffer;
      if (fs.existsSync(this.pathName) && this.options.coverIfFileExist === false) {
      ...
      return fs.writeFileSync(this.pathName, wsBuffer);
    };
