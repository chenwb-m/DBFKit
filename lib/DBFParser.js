...
(function() {
  var DBFParser, EventEmitter, Iconv, fs,
  ...
  DBFParser = (function(_super) {
    ...
    DBFParser.prototype._parseRecords = function(buffer) {
      var bufferLength, bufferTemp, curPoint, endPoint, field, i, point, record, _i, _j, _len, _ref, _ref1, _ref2, _results;
      endPoint = this.headOffset + this.recordLength * this.recordsCount - 1;
      bufferLength = buffer.length;
      bufferTemp = null;
      _results = [];
      for (point = _i = _ref = this.headOffset + 1, _ref1 = this.recordLength; _ref1 > 0 ? _i <= endPoint : _i >= endPoint; point = _i += _ref1) {
